...
const ProductGrid: React.FC<ProductGridProps> = ({
  ...
  {subtitle && (
    <div className="flex items-center  justify-between px-20 mb-6">
      ...
      {showSeeAll && (
        <button className=" w-24 h-8 text-[#00060D] bg-[#06C3CE] rounded-xl font-semibold hover:underline shadow-xl shadow- transition">
          See all
        </button>
      )}
    </div>
      ...
      {/* Grid */}
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-40 justify-items-center py-5 max-w-6xl mx-auto">
